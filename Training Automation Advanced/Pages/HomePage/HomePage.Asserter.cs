namespace Training_Automation_Advanced.Pages.Homepage
{
    ...
    //se extiende de Map porque vamos a estar utilizando los webelementos ubicados allí
    {
        ...
        public void AssertHomePProfileTXTAtLeft()
        {
            ...
            //string floatAttribute = GetStyle("#profileIMG","float");
        ...
        public void AssertHomePNotLoggedClickOnLorem()
        {

            Assert.AreEqual("Please click Login button to log into the application or sign up!",GetText(homePNotLoggedSecondTXT),"Sitio accesible deslogueado.");

        }

        public void AssertHomePNotLoggedClickOnForms()
        {
        ...
        {
            //obtengo estilos con funcion implementada en Base y con ese valor realizo assert
            //string position = GetStyle(".footerClass","position");
            //string bottom = GetStyle(".footerClass","bottom");
